...
//class BlueMenuViewModel (val navigator: WizardNavigator) {
//
//    val itemBinding: OnItemBind<WizardPageViewModel<User>>
//        get() = OnItemBind { itemBinding1, position, _ ->
//            when (position) {
//                0 -> itemBinding1.set(BR.viewModel, R.layout.fragment_customer_details)
//                1 -> itemBinding1.set(BR.viewModel, R.layout.fragment_bank_details)
//
...
//    val stateHolder = WizardStateHolder<User>(
//        User("", "", "","","","",
//        "","","","","","","","","","")
//    )
//
