...
class DashboardAdapterGreen(private var menuItems: ArrayList<DashboardItem>): RecyclerView.Adapter<DashboardAdapterGreen.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.layout_dashboard_green, parent, false)
